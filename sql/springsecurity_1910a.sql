/*
 ...
 Source Schema         : springsecurity_1910a

 Target Server Type    : MySQL
 Target Server Version : 50722
 File Encoding         : 65001

 Date: 28/05/2022 11:26:32
*/
...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES (1, '列表', '/list', 'List', '0', '0', 'sys:user:list', '#', NULL, NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_menu` VALUES (2, '删除', '/del', '', '0', '0', 'sys:user:del', '#', NULL, NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_menu` VALUES (3, '添加', '/add', NULL, '0', '0', 'sys:user:add', '#', NULL, NULL, NULL, NULL, 0, NULL);
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES (1, '超级管理员', NULL, '0', 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_role` VALUES (2, '普通用户', NULL, '0', 0, NULL, NULL, NULL, NULL, NULL);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'gaofei', '高飞', '$2a$10$kb.0CWCN7YTwtKoMeC8AKeT4kzvmz1CKuq1Kje0cLvSSTdpSvV1bu', '0', NULL, NULL, NULL, NULL, '1', NULL, NULL, NULL, NULL, 0);
INSERT INTO `sys_user` VALUES (2, 'test', 'test', '$2a$10$kb.0CWCN7YTwtKoMeC8AKeT4kzvmz1CKuq1Kje0cLvSSTdpSvV1bu', '0', NULL, NULL, NULL, NULL, '1', NULL, NULL, NULL, NULL, 0);
